...
function sizeOf(data) {
  ...
  if (Object.keys) {
    length = Object.keys(data).length; // available since ECMAScript 5 and in some browser 10x faster
  } else {
...
function mediahack(a, i) {
  function n(a, i) {
    var n = i.split(" "),
      l = a.classList;
    if (l)
      for (var i, e = 0; e < n.length; e++)(i = n[e]) && l.add(i);
    else {
  ...
  function l(a, i) {
    var n = i.split(" "),
      l = a.classList;
    if (l)
      for (var i, e = 0; e < n.length; e++)(i = n[e]) && l.remove(i);
    else {
